...
const rentalSchema=new Schema({
    ...
    title: {type: String, required:'Title is required',minlength:[5,'Title is too short, 5 chars are required'], maxlength:[100,'Title has too much characters reduce it to max. 100']},
